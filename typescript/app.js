...
var UserAccount = function () {
    var _classDecorators = [first()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var UserAccount = _classThis = /** @class */ (function () {
        function UserAccount_1(message) {
            this.message = message;
            console.log(this.message);
        }
        return UserAccount_1;
    }());
...
var user1 = new UserAccount('Omar');
...
console.log(typeof (test(10, 20))); // return String
